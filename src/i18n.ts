...
const en = {
  ...
  exportDocx: "Word document", exportHtml: "HTML document", settings: "Settings", about: "About MED",
...
const es = {
  ...
  exportDocx: "Documento de Word", exportHtml: "Documento HTML", settings: "Configuración", about: "Acerca de MED",
